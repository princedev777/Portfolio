...
st.write(
    "I Am a Junior Developer trying to make a career in the tech world as best as I can by learning skills and applying them into real world solutions,This was Never Truly a passion of mine at first but now it become a wonderful and eternal learning journey that i an happy to be a part of.....most times😂"
)
...
st.header("Projects")
st.subheader(
    "NB:Majority of these are incomplete due to constantly being busy with something else but they will be finished soon"
)
...
with project_column:
    ...
    st.link_button(
        "Simple QR code Generator", "https://github.com/Prince-afk119/QRCodeGenerator"
    )
    st.link_button(
        "Screen Time Manager", "https://github.com/Prince-afk119/ScreenTimeEarned"
    )
